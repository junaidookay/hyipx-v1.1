...
class ManualGatewayController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $method->admin_number = $request->receiver_number;
        $method->receiver_number = $request->receiver_number;
        $method->deposit_number = $request->receiver_number;
        $method->extra = ['receiver_name' => $request->receiver_name];
    ...
    public function update(Request $request, $code)
    {
        ...
        // Ensure singleCurrency exists before updating
        ...
        if ($singleCurrency) {
            ...
            // Handle the case where singleCurrency is null
            $notify[] = ['errors', 'No currency data found for this gateway.'];
            return back()->withNotify($notify);
        }
    ...
    public function delete($id)
    {
        ...
        fileManager()->removeFile(getFilePath('gateway') . '/' . $method->image);
        $method->currencies()->delete();
        $method->form()->delete();
        $method->delete();
        $notify[] = ['success', 'Manual gateway deleted successfully'];
        return back()->withNotify($notify);
    }
}

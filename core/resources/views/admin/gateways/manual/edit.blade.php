...
<div class="col-lg-12">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="receiver_number" value="{{ old('receiver_number', @$method->receiver_number) }}"/>
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="receiver_name" value="{{ old('receiver_name', @$method->extra->receiver_name) }}"/>

                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button--group">
                                            ...
                                            @endif
                                            <button class="btn btn-sm btn-outline--danger confirmationBtn" data-question="@lang('Are you sure to delete this gateway?')" data-action="{{ route('admin.gateway.manual.delete',$gateway->id) }}">
...
<a class="btn btn-outline--danger" href="{{ route('admin.security') }}"><i class="las la-shield-alt"></i>@lang('Security Audit')</a>

                        ...
                        <table class="table table--light style--two custom-data-table">
                            ...
                            @forelse($methods as $method)
                                <tr>
                                    ...
                                    <td class="fw-bold">{{ showAmount($method->min_limit) }} - {{ showAmount($method->max_limit) }}</td>
                                    <td>
                                        @php
                                    ...
                                    <td>
                                        <div class="button--group">
                                            ...
                                            @endif
                                            <button class="btn btn-sm btn-outline--danger ms-1 confirmationBtn" data-question="@lang('Are you sure to delete this method?')" data-action="{{ route('admin.withdraw.method.delete',$method->id) }}">

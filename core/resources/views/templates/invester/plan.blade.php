...
<div class="px-4">
    <div class="px-[5px] pb-[8px]">
        <h1 class="text-3xl font-bold text-white font-[Orbitron]">Investment Plans</h1>
        <p class="text-white text-sm">Purchase Your Investment Plans</p>
    </div>
                        ...
                        <div
                            ...
                            <span class="text-3xl font-black">
                                @if ($plan->fixed_amount > 0)
                                    {{ showAmount($plan->fixed_amount, 0) }}
                                @else
                                    {{ showAmount($plan->minimum, 0) }} - {{ showAmount($plan->maximum, 0) }}
                                @endif
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-green-300 font-black text-xl">
                             @if($plan->interest_type == 1)
                                {{ showAmount($plan->interest * 30, 0, currencyFormat: false) }} %
                             @else
                ...
                <div
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-cyan-300 font-black text-xl">
                            @if ($plan->lifetime == 0)
                                @if($plan->interest_type == 1)
                                    {{ showAmount($plan->interest * $plan->repeat_time, 0, currencyFormat: false) }} %
                                @else

    ...
    <script>
        (function($) {
            ...
            $('.detailsBtn').on('click', function() {
                ...
                modal.find('.investAmount').text(parseFloat(scheduleInvest.amount).toFixed(2) + ' ' + curSym);
                modal.find('.interestAmount').text(parseFloat(data.interest).toFixed(2) + ' ' + curSym);

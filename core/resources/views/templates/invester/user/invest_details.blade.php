                            ...
                            <li class="list-group-item d-flex justify-content-between">
                                ...
                                <span>
                                    @if ($plan->fixed_amount > 0)
                                        {{ showAmount($plan->fixed_amount, 2, currencyFormat: false) }}
                                    @else
                                        {{ showAmount($plan->minimum, 2, currencyFormat: false) }} - {{ showAmount($plan->maximum, 2, currencyFormat: false) }}
                                    @endif
                                </span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between">
                ...
                <div class="card custom--card">
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            <li class="list-group-item d-flex justify-content-between">
                                @lang('Initial Invest')
                                <span>{{ showAmount($invest->initial_amount, 2, currencyFormat: false) }} {{ gs('cur_text') }}</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between">
                                @lang('Current Invest')
                                <span>{{ showAmount($invest->amount, 2, currencyFormat: false) }} {{ gs('cur_text') }}</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between">
                                @lang('Invested')
                            ...
                            <li class="list-group-item d-flex justify-content-between">
                                ...
                                <span>{{ showAmount($invest->initial_interest, 2, currencyFormat: false) }} {{ gs('cur_text') }}</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between">
                                @lang('Current Interest')
                                <span>{{ showAmount($invest->interest, 2, currencyFormat: false) }} {{ gs('cur_text') }}</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between">
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex justify-content-between">
                                ...
                                <span>{{ showAmount($invest->paid, 2, currencyFormat: false) }} {{ gs('cur_text') }}</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between">
                                @lang('Should Pay')
                                <span>
                                    @if ($invest->should_pay != -1)
                                        {{ showAmount($invest->should_pay, 2, currencyFormat: false) }} {{ gs('cur_text') }}
                                    @else
                                        **
                                    @endif
                                </span>
                            ...
                            <li class="list-group-item d-flex justify-content-between">
                                @lang('Net Interest')
                                <span>{{ showAmount($invest->net_interest, 2, currencyFormat: false) }} {{ gs('cur_text') }}</span>
                            </li>
                        </ul>
                    </div>
                </div>

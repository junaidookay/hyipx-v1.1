...
<head>
    ...
    <title>{{ gs()->siteName(__()) }} - Login</title>
    ...
    <link rel="stylesheet" href="{{ asset('assets/theme/theme3/frontend/css/color.php?primary_color=F7931A') }}">
...
<section class="relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
        ...
        <svg class="absolute bottom-0 left-0 w-full h-full opacity-20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" preserveAspectRatio="none">
            <path fill="url(#wave1)" fill-opacity="0.3" d="M0,96L48,112C96,128,192,160,288,160C384,160,480,128,576,122.7C672,117,768,139,864,138.7C960,139,1056,117,1152,117.3C1248,117,1344,139,1392,149.3L1440,160L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z">
                <animate attributeName="d" dur="10s" repeatCount="indefinite" values="
                    ...
                    M0,160L48,149.3C96,139,192,117,288,117.3C384,117,480,139,576,138.7C672,139,768,117,864,122.7C960,128,1056,160,1152,160C1248,160,1344,128,1392,112L1440,96L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z;
                    M0,96L48,112C96,128,192,160,288,160C384,160,480,128,576,122.7C672,117,768,139,864,138.7C960,139,1056,117,1152,117.3C1248,117,1344,139,1392,149.3L1440,160L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z" />
            </path>
            <defs>
    ...
    <div class="relative z-10 w-full max-w-md">
        ...
        <div class="text-center mb-8 animate-fade-in">
            ...
            <p class="text-white/70 text-sm animate-fade-in-up">Sign in to continue your journey</p>
        </div>
        ...
        <div class="relative group animate-slide-up">
            ...
            <div class="relative bg-gradient-to-br from-blue-500/20 via-blue-600/20 to-purple-600/20 backdrop-blur-2xl border-2 border-white/20 rounded-3xl shadow-2xl p-8 overflow-hidden">
                ...
                <form class="action-form loginForm relative z-10" id="loginForm" action="{{ route('user.login') }}" method="post">
                    @csrf
                    <!-- Username Field -->
                    ...
                    <!-- Login Button with Multiple Effects -->
                    <button type="submit" class="relative group/btn w-full overflow-hidden rounded-2xl py-4 shadow-2xl transition-all duration-500 hover:scale-[1.02] hover:shadow-blue-500/50 mb-6">
                        ...
                        <!-- Button Content -->
                        <span class="relative z-10 flex items-center justify-center gap-3 text-white font-black text-lg loginSubmitBtn">
                            <svg class="w-5 h-5 transform group-hover/btn:rotate-180 transition-transform duration-500" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="relative mb-6">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span
                                class="px-4 bg-gradient-to-r from-blue-600/50 via-purple-600/50 to-pink-600/50 text-white/80 rounded-full">or</span>
                        </div>
                    </div>

                    <!-- Sign Up Link -->
                    <div class="text-center">
                        <p class="text-white/70 text-sm mb-2">Don't have an account?</p>
                        <a href="{{ route('user.register') }}"
                            class="inline-flex items-center gap-2 text-blue-300 hover:text-blue-200 font-bold text-base transition-colors duration-300">
                            Create Account
                            <svg class="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="currentColor"
                                viewBox="0 0 20 20">

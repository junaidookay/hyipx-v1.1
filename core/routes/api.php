...
use App\Http\Controllers\Gateway\AinPay\ProcessController;
...
Route::namespace('Api')->name('api.')->group(function () {
    ...
    Route::controller('SampleController')->group(function () {
        Route::get('verify', 'dbStatus');
    });
...
Route::get('/api/mobile-app', function () {

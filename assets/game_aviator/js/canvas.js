...
function setVariable(is_plan = '') {
    ...
    if (canvasWidth < 992) {
        ...
        imgyposition = 45;
        imgxposition = 10;
        imgTag.src = (typeof AVIATOR_IMAGE_PATH !== 'undefined' ? AVIATOR_IMAGE_PATH : "../images/") + "sprite2.png";
        settimeinterval = 40;
        ...
        imgyposition = 66;
        imgxposition = 15;
        imgTag.src = (typeof AVIATOR_IMAGE_PATH !== 'undefined' ? AVIATOR_IMAGE_PATH : "../images/") + "sprite3.png";
        settimeinterval = 20;
...
function upplane(x0, y0, x1, y1, x2, y2) {
    ...
    var IncreaseY = Math.max(5, estimateHeight - (countInterval / 5)); // Reduced wobble range and added safety min
    var DecreaseX = estimateWidth - (countInterval / 10);
...
function downplane(x0, y0, x1, y1, x2, y2) {
    ...
    var DecreaseY = Math.max(5, y2 + (countInterval / 5));
    var IncreaseX = x2 + (countInterval / 10);
